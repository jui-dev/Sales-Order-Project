        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">All Picking Lists</h3>
                </div>
                <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $pickingList->picking_type === 'retailer_to_customer' ? 'info' : 'primary' }}">
                                            {{ ucfirst(str_replace('_', ' ', $pickingList->picking_type)) }}
                                        </span>
                                    </td>
