...
<div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="mb-1">Retailer to Customer Picking</h1>
                <p class="text-muted mb-0">Outbound movement &mdash; stock leaving a retail location for a customer.</p>
            </div>
            <div>
...
<div class="container-fluid">
    ...
    <div class="alert alert-info d-flex align-items-center" role="alert">
        ...
        <div>
            <strong>How picking records are created:</strong> A record appears here when a customer places an order with retailer fulfillment, and is processed automatically when the order is completed.
        </div>
    </div>
